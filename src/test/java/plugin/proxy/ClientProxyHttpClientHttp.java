...
public class ClientProxyHttpClientHttp {
	...
	public ClientProxyHttpClientHttp(String host,int port){
		this.proxyHost = host;
		this.proxyPort = port;
	...
	public void doGetRequest() {
		// 目标地址
		String targetUrl = "http://www.zhuoju.xyz/?fromuid=32857";
		try {
			// 设置url参数 (可选)
...
//			System.out.println(result);
	...
	public String toString() {
		return "ClientProxyHttpClientHttp [proxyHost=" + proxyHost + ", proxyPort=" + proxyPort + ", proxy=" + proxy
				+ "]";
	}
}