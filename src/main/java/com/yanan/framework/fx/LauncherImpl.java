...
public class LauncherImpl {
    ...
    public static <T extends Application> void launchApplication(T appInstance,
            final String[] args) {
        ...
        launchApplication(appInstance, preloaderClass, args);
    }
     ...
     * @param args command line arguments
     */
    public static <T extends Application> void launchApplication(final T appInstance,
...
//                + preloaderClass);
        ...
        Thread launcherThread = new Thread(() -> {
            try {
                launchApplication1(appInstance, preloaderClass, args);
...
//    }
    ...
    private static <T extends Application> void launchApplication1(final T appInstance,
            final Class<? extends Preloader> preloaderClass,
            final String[] args) throws Exception {
    	 Class<? extends Application> appClass = appInstance.getClass();
        startToolkit();
